...
class MedFundsRaisedByUser extends StatefulWidget {
  const MedFundsRaisedByUser({super.key});

  @override
  State<MedFundsRaisedByUser> createState() => _MedFundsRaisedByUserState();
}

class _MedFundsRaisedByUserState extends State<MedFundsRaisedByUser> {
  @override
              ...
              StreamBuilder<DocumentSnapshot>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      if (userData != null &&
                          (userData as Map).containsKey('MedicalFR')) {
                        List<String> eduFRIds =
                            List<String>.from(userData['MedicalFR']);
                        return Column(
                          children: eduFRIds
                              .map((eduFrId) =>
