...
class EducationFRAdminDescriptive extends StatefulWidget {
  final DocumentSnapshot documentSnapshot;

  const EducationFRAdminDescriptive({Key? key, required this.documentSnapshot})
      : super(key: key);

  @override
  _EducationFRAdminDescriptiveState createState() =>
      _EducationFRAdminDescriptiveState();
}

class _EducationFRAdminDescriptiveState
    extends State<EducationFRAdminDescriptive> {
